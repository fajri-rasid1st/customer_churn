...
def do_predic(City, Zip_Code, Gender, Senior_Citizen, Partner, Dependents, Tenure_Months, Phone_Service, Multiple_Lines,
...
def index():
    ...
    result = do_predic(City, Zip_Code, Gender, Senior_Citizen, Partner, Dependents, Tenure_Months, Phone_Service, Multiple_Lines,
              Internet_Service, Online_Security, Online_Backup, Device_Protection, Tech_Support, Streaming_TV,
              Streaming_Movies, Contract, Paperless_Billing, Payment_Method, Monthly_Charges, Total_Charges)

    return render_template('index.html', cities=cities, zip_codes=zip_codes, genderS=genderS,
                           yes_or_no_only=yes_or_no_only, tenure_months=tenure_months, monthly_charges=monthly_charges,
                           total_charges=total_charges, city_number=city_number, zip_code_number=zip_code_number,
                           yes_or_no_only_number=yes_or_no_only_number, gender_number=gender_number,
                           yes_no_services=yes_no_services, yes_no_services_number=yes_no_services_number, result=result)
